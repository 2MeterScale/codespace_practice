...
# %%
# bokehで描画
from bokeh.models import BoxZoomTool, ColumnDataSource, CrosshairTool, HoverTool, PanTool, RedoTool, ResetTool, SaveTool, TapTool, UndoTool, WheelZoomTool, ZoomInTool, ZoomOutTool, Range1d
...
p = figure(title="XRD data", x_axis_label="2theta", y_axis_label="Intensity", x_range=x_range, width=1200, height=400, y_range=y_range)
...
p.add_tools(HoverTool(), CrosshairTool(), ZoomInTool(), ZoomOutTool(), UndoTool(), RedoTool())
