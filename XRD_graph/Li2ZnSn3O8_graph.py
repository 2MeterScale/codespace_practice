...
# %%
# bokehで描画
from bokeh.models import BoxZoomTool, ColumnDataSource, CrosshairTool, HoverTool, PanTool, RedoTool, ResetTool, SaveTool, TapTool, UndoTool, WheelZoomTool, ZoomInTool, ZoomOutTool
...
p = figure(title="XRD vs ICSD", x_axis_label="2theta", y_axis_label="Intensity", x_range=(10, 60), width=800, height=400)
...
p.add_tools(PanTool(), WheelZoomTool(), BoxZoomTool(), ResetTool(), SaveTool(), HoverTool(), TapTool(), CrosshairTool(), ZoomInTool(), ZoomOutTool(), UndoTool(), RedoTool())
